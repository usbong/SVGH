...
'   java generateMonthlySummaryReportWithDiagnosedCasesOfAllInputFilesSVGH input_201801.txt
' 
...
'   java generateMonthlySummaryReportWithDiagnosedCasesOfAllInputFilesSVGH input*
' 
...
'   java generateMonthlySummaryReportWithDiagnosedCasesOfAllInputFilesSVGH *"2018"*.txt
'
...
'   javac -cp .;org.apache.commons.text.jar generateMonthlySummaryReportWithDiagnosedCasesOfAllInputFilesSVGH.java
'
...
'   java -cp .;org.apache.commons.text.jar generateMonthlySummaryReportWithDiagnosedCasesOfAllInputFilesSVGH *.txt
'
...
public class generateMonthlySummaryReportWithDiagnosedCasesOfAllInputFilesSVGH {	
...
*/	
	...
	//added by Mike, 20190518
	private static final int INPUT_SWT_AND_LASER_PT_HMO_CASH_COLUMN = 19 - INPUT_NON_MASTER_LIST_OFFSET;
	...
	//added by Mike, 20190611
	private static final int INPUT_IN_PATIENT_DIAGNOSIS_COLUMN = 15-INPUT_NON_MASTER_LIST_OFFSET -2; //COLUMN M, instead of COLUMN O
...
//	private static HashMap<String, String> knownDiagnosedCasesContainer; //added by Mike, 20190412
	...
	private static final int OUTPUT_PT_TRANSACTIONS_COUNT_SWT_CASH_COLUMN = 5;
	private static final int OUTPUT_PT_TRANSACTIONS_COUNT_SWT_HMO_COLUMN = 6;
...
//			System.out.println("inputPhysicalTherapist: "+inputPhysicalTherapist);
			...
			boolean hasPlusAreaKeywords=false;
...
*/				
				...
				//edited by Mike, 20190611
				String[] inputStringArray;
				if (inputFilename.toUpperCase().contains("IN-PATIENT")) {
					inputStringArray = inputColumns[INPUT_IN_PATIENT_DIAGNOSIS_COLUMN].toUpperCase().split(" ");	
				}
				else {
					inputStringArray = inputColumns[INPUT_DIAGNOSIS_COLUMN].toUpperCase().split(" ");
				}

				//String[] inputStringArray = inputColumns[INPUT_DIAGNOSIS_COLUMN].toUpperCase().split(" ");
				String[] s = plusAreaCountKeywordContainerArrayList.get(h)[0].split(" ");
				//String s = plusAreaCountKeywordContainerArrayList.get(h)[0];
...
//					break;
			...
			if (!physicalTherapistContainer.containsKey(inputPhysicalTherapist)) {
				...
				if (isHMO) {
					...
					else if (inputFilename.toUpperCase().contains("SWT")) {
...
//					}
					...
					String[] inputStringArray = inputColumns[INPUT_DIAGNOSIS_COLUMN].toUpperCase().split(" ");	String[] s = plusAreaCountKeywordContainerArrayList.get(h)[0].split(" ");
